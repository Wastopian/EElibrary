...
| Subcategory search | `PRODUCT_REQUIREMENTS.md` | Shipped | `apps/api/src/catalog-store.ts`, `apps/web/src/app/catalog/page.tsx` | Category facet (parent / subcategory string) is grouped in SQL with counts and rendered in the filter rail and active-filter pills. |
